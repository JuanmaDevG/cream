...
int main()
{
    ...
    _cargs_push_extended_argument("some-argument", 0, _cargs_bool_args, 0);
    _cargs_push_extended_argument("some-other-arg", 0, _cargs_data_args, 1);
    ...
    assert(_extended_args.args[0].read_point == _cargs_bool_args);
    ...
    assert(_extended_args.args[1].read_point == _cargs_data_args);
