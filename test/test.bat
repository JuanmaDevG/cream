...
set sources=%source_dir%error_str.c %source_dir%shared_data.c %source_dir%utils.c %source_dir%anon_arg_list.c %source_dir%init_funcs.c %source_dir%bit_vec_ops.c
