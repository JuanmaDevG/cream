...
int main()
{
    ...
    assert(_cargs_data_packs.packages[0].count == 2);
    assert(_cargs_data_packs.packages[0].values == tmp_argv +2);
    assert(arg_index == 3);
    ...
    assert(_cargs_data_packs.packages[2].count == 3);
    assert(_cargs_data_packs.packages[2].values == tmp_argv + 5);
    assert(arg_index == 7);

    assert(_cargs_data_packs.packages[1].count == 0);
    assert(_cargs_data_packs.packages[1].values == NULL);
